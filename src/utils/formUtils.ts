import { Input } from "@/components/Input"; // Импорт типа Input
...
export function createFormSubmitHandler(
  ...
  return (e: Event) => {
    ...
    inputs.forEach((input: Input) => {
      ...
      console.log(`Input "${input || "unknown"}": isValid=${isValid}, error="${error || "none"}"`); // Лог
    ...
    console.log(`Overall form: isValid=${isFormValid}, data=`, formData); // Общий лог
